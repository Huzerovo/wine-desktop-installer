...
# source code archive
conf_box64_tar="box64_${conf_box64_version}.tar.gz"
conf_box86_tar="box86_${conf_box86_version}.tar.gz"
...
# 64-bit version
LINK64="https://dl.winehq.org/wine-builds/${os}/dists/${dist}/main/binary-amd64"
...
# 32-bit version
LINK32="https://dl.winehq.org/wine-builds/${os}/dists/${dist}/main/binary-i386"
